...
import System.Unix.LazyProcess(Output(..), collectOutputUnpacked, mergeToStdout, lazyProcess, stdoutOnly)
...
import System.Unix.LazyProcess (collectResult, exitCodeOnly)
