#!/usr/bin/runhaskell -package=base-3.0.3.0
...
params = 
    ...
    { verbosity = 0,
      ...
      sources = 
          [unlines
           ["sid",
            " deb http://" ++ ubuntuMirrorHost ++ "/debian sid main contrib non-free",
            " deb-src http://" ++ ubuntuMirrorHost ++ "/debian sid main contrib non-free"],
           unlines
           ["sid-seereason",
            " deb http://" ++ ubuntuMirrorHost ++ "/debian sid main contrib non-free",
            " deb-src http://" ++ ubuntuMirrorHost ++ "/debian sid main contrib non-free",
           ...
           unlines
           ["etch",
            " deb http://" ++ ubuntuMirrorHost ++ "/debian etch main contrib non-free",
            " deb-src http://" ++ ubuntuMirrorHost ++ "/debian etch main contrib non-free"],
           unlines
           ["sarge",
            " deb http://" ++ ubuntuMirrorHost ++ "/debian sarge main contrib non-free",
            " deb-src http://" ++ ubuntuMirrorHost ++ "/debian sarge main contrib non-free"],
           unlines
           ["lenny",
            " deb http://" ++ ubuntuMirrorHost ++ "/debian lenny main contrib non-free",
            " deb-src http://" ++ ubuntuMirrorHost ++ "/debian lenny main contrib non-free"],
           unlines
           ["lenny-seereason",
            " deb http://" ++ ubuntuMirrorHost ++ "/debian lenny main contrib non-free",
            " deb-src http://" ++ ubuntuMirrorHost ++ "/debian lenny main contrib non-free",
           ...
           unlines
           ["debian-experimental",
            " deb http://" ++ ubuntuMirrorHost ++ "/debian experimental main contrib non-free",
            " deb-src http://" ++ ubuntuMirrorHost ++ "/debian experimental main contrib non-free"],
           unlines
           ["feisty",
            "  deb http://" ++ ubuntuMirrorHost ++ "/ubuntu/ feisty main restricted universe multiverse",
            "  deb-src http://" ++ ubuntuMirrorHost ++ "/ubuntu/ feisty main restricted universe multiverse",
            "  deb http://" ++ ubuntuMirrorHost ++ "/ubuntu/ feisty-updates main restricted universe multiverse",
            "  deb-src http://" ++ ubuntuMirrorHost ++ "/ubuntu/ feisty-updates main restricted universe multiverse",
            "  deb http://" ++ ubuntuMirrorHost ++ "/ubuntu/ feisty-backports main restricted universe multiverse",
            "  deb-src http://" ++ ubuntuMirrorHost ++ "/ubuntu/ feisty-backports main restricted universe multiverse",
            "  deb http://" ++ ubuntuMirrorHost ++ "/ubuntu/ feisty-security main restricted universe multiverse",
            "  deb-src http://" ++ ubuntuMirrorHost ++ "/ubuntu/ feisty-security main restricted universe multiverse"],
           unlines
           ["gutsy",
            "  deb http://" ++ ubuntuMirrorHost ++ "/ubuntu/ gutsy main restricted universe multiverse",
            "  deb-src http://" ++ ubuntuMirrorHost ++ "/ubuntu/ gutsy main restricted universe multiverse",
            "  deb http://" ++ ubuntuMirrorHost ++ "/ubuntu/ gutsy-updates main restricted universe multiverse",
            "  deb-src http://" ++ ubuntuMirrorHost ++ "/ubuntu/ gutsy-updates main restricted universe multiverse",
            "  deb http://" ++ ubuntuMirrorHost ++ "/ubuntu/ gutsy-backports main restricted universe multiverse",
            "  deb-src http://" ++ ubuntuMirrorHost ++ "/ubuntu/ gutsy-backports main restricted universe multiverse",
            "  deb http://" ++ ubuntuMirrorHost ++ "/ubuntu/ gutsy-security main restricted universe multiverse",
            "  deb-src http://" ++ ubuntuMirrorHost ++ "/ubuntu/ gutsy-security main restricted universe multiverse"],
           unlines
           ["hardy",
            "  deb http://" ++ ubuntuMirrorHost ++ "/ubuntu/ hardy main restricted universe multiverse",
            "  deb-src http://" ++ ubuntuMirrorHost ++ "/ubuntu/ hardy main restricted universe multiverse",
            "  deb http://" ++ ubuntuMirrorHost ++ "/ubuntu/ hardy-updates main restricted universe multiverse",
            "  deb-src http://" ++ ubuntuMirrorHost ++ "/ubuntu/ hardy-updates main restricted universe multiverse",
            "  deb http://" ++ ubuntuMirrorHost ++ "/ubuntu/ hardy-backports main restricted universe multiverse",
            "  deb-src http://" ++ ubuntuMirrorHost ++ "/ubuntu/ hardy-backports main restricted universe multiverse",
            "  deb http://" ++ ubuntuMirrorHost ++ "/ubuntu/ hardy-security main restricted universe multiverse",
            "  deb-src http://" ++ ubuntuMirrorHost ++ "/ubuntu/ hardy-security main restricted universe multiverse"],
           unlines
           ["intrepid",
            "  deb http://" ++ ubuntuMirrorHost ++ "/ubuntu/ intrepid main restricted universe multiverse",
            "  deb-src http://" ++ ubuntuMirrorHost ++ "/ubuntu/ intrepid main restricted universe multiverse",
            "  deb http://" ++ ubuntuMirrorHost ++ "/ubuntu/ intrepid-updates main restricted universe multiverse",
            "  deb-src http://" ++ ubuntuMirrorHost ++ "/ubuntu/ intrepid-updates main restricted universe multiverse",
            "  deb http://" ++ ubuntuMirrorHost ++ "/ubuntu/ intrepid-backports main restricted universe multiverse",
            "  deb-src http://" ++ ubuntuMirrorHost ++ "/ubuntu/ intrepid-backports main restricted universe multiverse",
            "  deb http://" ++ ubuntuMirrorHost ++ "/ubuntu/ intrepid-security main restricted universe multiverse",
            "  deb-src http://" ++ ubuntuMirrorHost ++ "/ubuntu/ intrepid-security main restricted universe multiverse"],
           unlines
           ["jaunty",
            "  deb http://" ++ ubuntuMirrorHost ++ "/ubuntu/ jaunty main restricted universe multiverse",
            "  deb-src http://" ++ ubuntuMirrorHost ++ "/ubuntu/ jaunty main restricted universe multiverse",
            "  deb http://" ++ ubuntuMirrorHost ++ "/ubuntu/ jaunty-updates main restricted universe multiverse",
            "  deb-src http://" ++ ubuntuMirrorHost ++ "/ubuntu/ jaunty-updates main restricted universe multiverse",
            "  deb http://" ++ ubuntuMirrorHost ++ "/ubuntu/ jaunty-backports main restricted universe multiverse",
            "  deb-src http://" ++ ubuntuMirrorHost ++ "/ubuntu/ jaunty-backports main restricted universe multiverse",
            "  deb http://" ++ ubuntuMirrorHost ++ "/ubuntu/ jaunty-security main restricted universe multiverse",
            "  deb-src http://" ++ ubuntuMirrorHost ++ "/ubuntu/ jaunty-security main restricted universe multiverse"],
           unlines
           ["hardy-seereason",
            "  deb http://" ++ ubuntuMirrorHost ++ "/ubuntu/ hardy main restricted universe multiverse",
            "  deb-src http://" ++ ubuntuMirrorHost ++ "/ubuntu/ hardy main restricted universe multiverse",
